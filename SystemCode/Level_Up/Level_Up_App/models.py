...
class Questionaire(models.Model):
    ...
    CAREER_POSITION_CHOICES = [
        ...
        ('TECHFEL', 'Technical Fellow'),
        ('SOFTVP', 'Vice President, Software'),
        ('SENTECHFEL', 'Senior Technical Fellow'),
