...
class EndGoal(KnowledgeEngine):
	...
	def ENFJ(self):
		global recommendedjob
		recommendedjob = "Senior Director"

	@Rule(PersonalityList(charlist = 'ENFP'))
	def ENFP(self):
		global recommendedjob
		recommendedjob = "Senior Sales Director"

	@Rule(PersonalityList(charlist = 'INFP'))
	def INFP(self):
		global recommendedjob
		recommendedjob = "Senior Software Director"

	@Rule(PersonalityList(charlist = 'INFJ'))
	def INFJ(self):
		global recommendedjob
		recommendedjob = "Director"

	@Rule(PersonalityList(charlist = 'ESFJ'))
	def ESFJ(self):
		global recommendedjob
		recommendedjob = "President"

	@Rule(PersonalityList(charlist = 'ESFP'))
	def ESFP(self):
		global recommendedjob
		recommendedjob = "Principal Engineer"
	
	@Rule(PersonalityList(charlist = 'ISFP'))
	def ISFP(self):
		global recommendedjob
		recommendedjob = "Principal Software Engineer"

	@Rule(PersonalityList(charlist = 'ISFJ'))
	def ISFJ(self):
		global recommendedjob
		recommendedjob = "Sales Director"

	@Rule(PersonalityList(charlist = 'ESTJ'))
	def ESTJ(self):
		global recommendedjob
		recommendedjob = "Software Director"

	@Rule(PersonalityList(charlist = 'ESTP'))
	def ESTP(self):
		global recommendedjob
		recommendedjob = "Vice President"

	@Rule(PersonalityList(charlist = 'ISTP'))
	def ISTP(self):
		global recommendedjob
		recommendedjob = "Senior Solution Architect"

	@Rule(PersonalityList(charlist = 'ISTJ'))
	def ISTJ(self):
		global recommendedjob
		recommendedjob = "Professor"
